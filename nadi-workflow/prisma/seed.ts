...
async function main() {
  ...
  const fcTemplate = await prisma.workflowTemplate.create({
    data: {
      ...
      configJson: JSON.stringify({
        nodes: [
          { id: "trigger", type: "trigger", label: "CSV Import" },
          { id: "normalize", type: "logic", label: "Normalize & Dedupe" },
          { id: "classify", type: "ai", label: "AI Classification" },
          { id: "confidence", type: "confidence_gate", label: "Confidence Gate" },
          { id: "post", type: "execute", label: "Post to Ledger" },
          { id: "review", type: "execute", label: "Route to Review" },
          { id: "audit", type: "audit", label: "Write Audit" },
        ],
        edges: [
  ...
  await prisma.workflowTemplate.create({
    data: {
      ...
      configJson: JSON.stringify({
        nodes: [
          { id: "trigger", type: "trigger", label: "Schedule / Manual" },
          { id: "fetch", type: "logic", label: "Fetch Unit Economics" },
          { id: "compute", type: "logic", label: "Compute Net Margin" },
          { id: "policy", type: "policy_check", label: "Policy Check" },
          { id: "draft", type: "execute", label: "Draft Price Change" },
          { id: "approval", type: "approval", label: "Owner Approval" },
          { id: "execute", type: "execute", label: "Apply Change" },
          { id: "audit", type: "audit", label: "Write Audit" },
        ],
        edges: [
